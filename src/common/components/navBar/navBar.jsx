...
function createData(name, statusBoolean, priceNumber, capacityNumber) {
    ...
    const capacity = `${capacityNumber} ` + <Trans id="table.pessoas">pessoas</Trans>;
    const status = statusBoolean ? <Trans id="table.statusAtivo">Ativo</Trans> : <Trans id="table.statusInativo">Inativo</Trans>;
