...
const BlockTimeGroup = () => {
  ...
  const handleSubmit = (values) => {
    ...
    const blockData = {
      userId:
        scheduleState && scheduleState[0] ? scheduleState[0].userId : null,
  ...
  const localeText = [
    { ariaLabel: "domingo", text: "D" },
    { ariaLabel: "segunda-feira", text: "S" },
    { ariaLabel: "terça-feira", text: "T" },
    { ariaLabel: "quarta-feira", text: "Q" },
    { ariaLabel: "quinta-feira", text: "Q" },
    { ariaLabel: "sexta-feira", text: "S" },
    { ariaLabel: "sábado", text: "S" },
  ];

  const updateWeekDays = () => {
    localeText.forEach((header, idx) => {
      const headerDay = document.querySelector(
              ...
              <DatePicker
                ...
                maxDate={
                  formik.values.initialDate
                    ? dayjs(formik.values.initialDate).add(3, "month")
                    : null
                }
