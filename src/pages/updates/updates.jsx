            ...
            <Grid container display="flex" flexDirection="column" spacing={3}>
                <Grid item >
                    ...
                    <Card>
                        ...
                        <CardActions>
                            <Button size="small" color="primary">Assine e Transforme Seu Negócio</Button>
                        </CardActions>
                    </Card>
                </Grid>
                ...
                <Grid item >
                    ...
                    <Card>
                        ...
                        <CardActions>
                            <Button size="small" color="primary">Garanta Já o Seu</Button>
                        </CardActions>
                    </Card>
                </Grid>
                ...
                <Grid item >
                    ...
                    <Card>
                        ...
                        <CardActions>
                            <Button size="small" color="primary">Adicione ao Seu Carrinho</Button>
                        </CardActions>
                    </Card>
                </Grid>
                ...
                <Grid item >
                    ...
                    <Card>
                        ...
                        <CardActions>
                            <Button size="small" color="primary">Aproveite Esta Oferta Agora</Button>
                        </CardActions>
                    </Card>
                </Grid>
            </Grid>
