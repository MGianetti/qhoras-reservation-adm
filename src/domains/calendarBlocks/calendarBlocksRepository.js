...
const createCalendarBlock = (userId, initialDate, endDate, initialTime, endTime) =>
    makeRequest(() => apiService.post(endpoints.create.calendarBlock.replace('${USER-ID}', userId), { initialDate, endDate, initialTime, endTime }));
