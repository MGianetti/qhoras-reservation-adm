...
function CalendarBoard(props) {
    ...
    const getBlockData = (day) => {
        const dayBlocks = (calendarBlocks || []).filter((block) => format(new Date(block.initialTime), 'yyyyMMdd', { locale: ptBR }) === format(day, 'yyyyMMdd', { locale: ptBR }));
