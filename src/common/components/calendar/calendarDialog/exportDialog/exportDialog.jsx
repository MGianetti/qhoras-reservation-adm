...
import { Dialog, DialogTitle, DialogContent, Button, Typography, Grid, Box } from '@mui/material';
...
function ExportReservationDialog({ open, setOpenExportDialog }) {
    ...
    const handleSubmit = async (values) => {
        ...
        const arrayBuffer = await appointmentService.exportReservations(businessId, startFormatted, endFormatted);
                ...
                <DialogContent>
                    <Box sx={{ mt: 2 }} component="form" onSubmit={formik.handleSubmit}>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <DatePicker
                                    ...
                                    onChange={(newValue) => formik.setFieldValue('initialDate', newValue)}
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                            ...
                            <Button type="submit" variant="contained" disabled={!formik.isValid || !formik.values.initialDate || !formik.values.endDate}>
                                Exportar
                            </Button>
                        </Box>
                    </Box>
