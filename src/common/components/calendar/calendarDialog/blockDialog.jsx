                                ...
                                <Grid item xs={12} sm={8} style={{ paddingBlock: 15 }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                            <Typography> {format(new Date(eventBeginDate), 'dd/MM/yyyy', { locale: ptBR })} - {format(new Date(eventEndDate), 'eeee', { locale: ptBR })}</Typography>   
                                        </div>
                                    </div>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={4} style={{ display: 'flex', justifyContent: isSmUp ? 'flex-end' : 'flex-start', paddingBlock: 15 }}>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                                            <Typography sx={{ color: '#7c7c7c', border: '1px solid #bebebe', padding: '8px 10px', borderRadius: 1 }}>{initialTime}</Typography>
